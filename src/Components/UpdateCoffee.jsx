...
const UpdateCoffee = () => {
     ...
     const  data  = useLoaderData();
        const {_id,name,quantity,price,taste,suplier,details,photo} = data;
              console.log(data); 
    ...
    return (
         <div className='p-24'>
             <div className='p-24 text-center space-y-4'>
                <h1 className='text-6xl text-center'>Update Coffee</h1>
            </div> 
...
<fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
  ...
  <input type="text"  name='suplier' defaultValue={suplier} className="input w-full" placeholder="Supplier Name" />
</fieldset>
<fieldset className="fieldset bg-base-200 border-base-300 rounded-box  border p-4">
